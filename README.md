...
**华为云通道 · 告警联动**（风扇随温度超标自动开启，井下状态变红）

<img src="docs/images/app_cloud_channel.jpg" width="280" alt="华为云通道告警联动">

**温度过高告警弹窗**（32.5℃ 超过固件阈值 32℃，实时弹窗+震动提醒）

<img src="docs/images/app_alarm_temp.jpg" width="280" alt="温度过高告警弹窗">

**震动告警弹窗**（MPU6050 检测到异常震动）

<img src="docs/images/app_alarm_shake.jpg" width="280" alt="震动告警弹窗">

**历史数据**（30 条滚动记录，正常/危险标签，支持一键清空）

<img src="docs/images/app_history.jpg" width="280" alt="历史数据页">
